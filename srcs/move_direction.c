...
/*   Updated: 2022/07/14 10:54:23 by fmollenh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	p = data->player;
	x = (int)(p->x_calc + (sin(degree_in_radiant(p->direction_d)) * 0.6));
	y = (int)(p->y_calc + (-cos(degree_in_radiant(p->direction_d)) * 0.6));
	if (data->map->map[y][x] == '1')
		return (0);
